...
def parse():
    parser = argparse.ArgumentParser(
                        ...
                        description='',
                        epilog='')
    parser.add_argument('-ni', '--n_input_qubit',dest='n_input_qubit' ,help='aaaaaaaaaaaaaaaa',type=int, default=8)           # positional argument
    ...
    parser.add_argument('-ls','--list-op-support', required=False, type=int, default=[1,2],
    ...
    parser.add_argument('-lr','--list-op-support-max-range', required=False, type=int, default=[1,3,1,1],
